...
public class NavigationAndThreadWindow extends JFrame implements TreeSelectionListener, Observer, ChangeListener {
	...
	public NavigationAndThreadWindow(Thread p_topLevelThread) {
		super();
		...
		setSize(GUIConstants.s_navAndThreadWindowSize);
